...
class Test {
    ...
    run() {
        ...
        let hideGrid = () => {
            document.querySelector('#svg-animation').style.display = 'none';
        }


        // square grid
        let grid = () => {
            document.querySelector('#svg-animation').style.display = 'block';
        ...
        new scroll('div2', '40%', grid, hideGrid);
        new scroll('div3', '50%', grid2, grid);
        new scroll('div5', '50%', divide, grid);
        new scroll('div7', '50%', barChart, divide);



        // //start grid on second div
        // grid();
    }
