class FormatChartData {
    ...
    createDegreeDropdown(d) {
        ...
        document.querySelector('.degreeType-select-form').appendChild(this.dropdownListDegreeType);
        document.querySelector('.dropdown-degree label').innerHTML = "Select degree";
    ...
    createCourseDropdown(d) {
        ...
        document.querySelector('.course-select-form').appendChild(this.dropdownListCourse);
        document.querySelector('.dropdown-course label').innerHTML = "Select course";
